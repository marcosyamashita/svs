                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><table width="95%" border="0" align="center">
                            <tr>
                              <td align="left"><h4>Seus dados pessoais foram validados. Agora você pode votar!<br>
Por favor, selecione a chapa desejada.<br>
Depois, confirme o seu voto no final da página.
</h4>
...
for($i=1;$i<=$count_geral;$i++){
     ...
     while($row = mysqli_fetch_array($query_sel_cand_unid)){
        ...
        if ($candidato_nome != ""){
           $vetor_cand_unid[$v] = $candidato_nome.'#'.$candidato_descricao.'#'.$candidato_id; // vetor com as informações unidade do associado.
...
// exibe a linha de voto nulo:
     ...
     $query_sel_nulo = mysqli_query($link, $sel_nulo) or die(mysql_error($link));

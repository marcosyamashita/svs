                          ...
                          <td><table width="95%" border="0" align="center">
                            ...
                            <tr>
                              <td align="center"><p>Para acessar o Sistema de Vota&ccedil;&atilde;o &eacute; necess&aacute;rio validar alguns dados cadastrais.<br />
                                  <strong>Preencha corretamente os seguintes campos: </strong></p>
                                <table width="75%" border="0" cellpadding="2" cellspacing="2" align="center">
                                  ...
                                  <td><strong>ATEN&Ccedil;&Atilde;O: caso possua mais de uma conta-corrente:<br>
- informe apenas uma das contas no campo<br>
- verifique se houve o aceite da valida&ccedil;&atilde;o.<br>
Em caso negativo, informe a outra conta</strong></td>
                                  <tr>
                                    ...
                                    <td colspan="2" bgcolor="#8A0002" align="center" style="padding-top: 10px; padding-bottom: 10px"><font color="#FFFFFF">DADOS INCORRETOS.<br />
                                    TENTE NOVAMENTE.</font></td>
                                  </tr>
                                </table></td>
                            </tr>
                            <tr>

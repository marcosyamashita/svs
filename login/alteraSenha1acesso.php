...
$result_snh=mysqli_query($link, $update,$link) or die(mysqli_error($link));

$select_acesso = "select acesso from tb_usuario where login = '$login_0';";
$query_acesso0 = mysqli_query($link, $select_acesso) or die(mysqli_error($link));
while($row = mysqli_fetch_array($query_acesso0)){
...
$result_acesso=mysqli_query($link, $update_acesso,$link) or die(mysqli_error($link));
...
<!-- RPSystem -->
  ...
  <div id="templatemo_content">
	...
	<div id="templatemo_footer">
    	<div id="top"></div>
    	Copyright &Acirc;&copy; 2010 <strong>TCC</strong>
		| Victor Cova e M&Atilde;&iexcl;rcio Bastos
        <div id="bottom"></div>
	</div>
</div>
</body>

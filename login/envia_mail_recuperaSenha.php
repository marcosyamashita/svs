...
$dtNasc_recupera = $separa[2].'-'.$separa[1].'-'.$separa[0]; //corrigindo para compara��o no banco. Ex: 2001-01-01
//------------------------ORGANIZADO!!!


  $select_dados = "select login,senha from tb_usuario where email = '$mail_recupera' and data_nacimento = '$dtNasc_recupera';";
  $query_recovery = mysqli_query($link, $select_dados) or die(mysqli_error($link));
  while($row = mysqli_fetch_array($query_recovery)){
     $val_login = $row["login"];
     $val_senha = $row["senha"];
  }
...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>RPSystem - Recuperar Senha</title>
...
<div id="templatemo_container">
  ...
  <div id="templatemo_content">
	...
	<div id="templatemo_footer">
    	<div id="top"></div>
    	Copyright &copy; 2010 <strong>TCC</strong> | Victor Cova e M&aacute;rcio Bastos
        <div id="bottom"></div>
	</div>
